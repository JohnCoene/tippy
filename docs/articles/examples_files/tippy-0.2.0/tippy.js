...
const callTippy = (params) => {
	if(params.options.content != undefined){
		(0,tippy_js__WEBPACK_IMPORTED_MODULE_2__.default)(params.selector, params.options);
		return ;
	}

	(0,tippy_js__WEBPACK_IMPORTED_MODULE_2__.default)(params.selector);
}
